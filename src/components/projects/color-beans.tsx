...
export function ColorBeans() {
  ...
  return (
    <button
      className="my-16 flex w-full items-center justify-center gap-4 rounded-full border border-neutral-800 px-12 py-4 text-left transition-all hover:bg-neutral-950 sm:w-auto"
